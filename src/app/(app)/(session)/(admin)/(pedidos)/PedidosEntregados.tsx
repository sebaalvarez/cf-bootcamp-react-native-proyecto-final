...
import { selectAllPedidosPorEstado } from "@/src/services/api/supabase/pedidos";
...
export default function PedidosEntregados({ lightColor, darkColor }: Props) {
  ...
  async function getPedido() {
    setLoading(true);
    const ped = await selectAllPedidosPorEstado(EstadosPedido.ENTREGADO);
    setPedidos(ped);
    setLoading(false);
  }
  useEffect(() => {
